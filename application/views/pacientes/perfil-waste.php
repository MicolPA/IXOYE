<div class="row contenedor">
	<div class="col-md-3 col-lg-3 col-sm-3">
		<img src="<?php echo base_url('assets/images/user.png') ?>" width="80%">
		<div class="info">
				...
				<div class="col-lg-4 text-center" id="cita">
						<div class="cardBoxCommon">
				            ...
				            <div class="card-footer">
				            	<a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash" title="Borrar"></i></a>
				            	<a href="#" class="btn btn-primary btn-xs" title="Editar"><i class="fui-new"></i></a>
